...
parser.add_argument('--train-data', type=str, default='/home/charlie/nlp/data/roc_key.train',
                    help='location of the training data corpus')
parser.add_argument('--valid-data', type=str, default='/home/charlie/nlp/data/roc_key.test',
                    help='location of the valid data corpus')
parser.add_argument('--test-data', type=str, default='/home/charlie/nlp/data/roc_key.test',
...
parser.add_argument('--resume', type=str,  default='pretrain/pretrain.pt',
