...
parser.add_argument('--conditional-data', type=str, default='/home/charlie/nlp/output/roc_title.test',
...
parser.add_argument('--checkpoint', type=str, default='/home/charlie/nlp/output/stage1.pt',
...
parser.add_argument('--outf', type=str, default='/home/charlie/nlp/output/roc_key.test',
