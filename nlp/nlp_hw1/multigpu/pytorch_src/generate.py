...
parser.add_argument('--conditional-data', type=str, default='../rocstory_plan_write/ROCStories_all_merge_tokenize.title.test',
...
parser.add_argument('--sents', type=int, default='100',
