...
parser.add_argument('--conditional-data', type=str, default='/home/charlie/nlp/data/roc_key.test',
...
parser.add_argument('--outf', type=str, default='results/result.txt',
                    help='output file for generated text')
parser.add_argument('--sents', type=int, default='10',
            ...
            while nsent < args.sents:
                ...
                for i in range(args.words):
                    if i < cond_length:
                        ...
                        if output.shape[1] != len(corpus.dictionary):
                            print(output.shape, len(corpus.dictionary))
                            sys.exit("pretrain error, mismatch encoder decoder size.")
                        if args.dedup:
