...
for i in range(2, 9):
    for j in range(2, 9):
        with open('train_hxs_pairs/{}_{}.json'.format(i, j), 'w', encoding="utf-8")  as fout:
...
with open('ci.test.hxs.json', 'w', encoding="utf-8")  as fout:
