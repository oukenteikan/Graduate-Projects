...
class Lang:
    def __init__(self):
        self.word2index = {"<pad>":0, "<SOS>":1}
        self.word2count = {}
        self.index2word = {0:"<pad>", 1: "<SOS>"}
...
class SongCiDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        src = [self.lang.word2index["<SOS>"]] + SongCi["src"]
        trg = [self.lang.word2index["<SOS>"]] + SongCi["trg"]
...
def collate_fn(items):
    ...
    return {"src":pad_tensor(srcs), "trg":pad_tensor(trgs)}
